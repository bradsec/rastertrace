...
test("sniffImageSize reads JPEG dimensions from SOF marker", async () => {
  const bytes = [
    0xff, 0xd8, 0xff, 0xe0, 0x00, 0x04, 0x00, 0x00, 0xff, 0xc0, 0x00, 0x0b, 0x08, 0x03, 0x20, 0x05,
    0x00, 0x03, 0x01, 0x11, 0x00,
  ];
...
test("sniffImageSize reads WebP VP8X dimensions", async () => {
  const bytes = [
    0x52, 0x49, 0x46, 0x46, 0, 0, 0, 0, 0x57, 0x45, 0x42, 0x50, 0x56, 0x50, 0x38, 0x58, 0, 0, 0, 0,
    0, 0, 0, 0, 0xff, 0x03, 0x00, 0xff, 0x01, 0x00,
  ];
